...
export const AcceptTask = ({data}) => {
      ...
      return ( 
            <div className="h-full w-[20%] bg-red-400 rounded-2xl flex-shrink-0">
                  ...
                  <div className="flex justify-between mt-4">
                        <button className="bg-green-500 py-1 px-2 text-sm m-1 rounded text-teal-50">Mark as Completed</button>
                        <button className="bg-red-500 py-1 px-2 text-sm m-1 rounded text-teal-50">Mark as Failed</button>
                  </div>
            </div>
       );
}
